...
export class WorkspaceTagsService implements IWorkspaceTagsService {
	...
	/* __GDPR__FRAGMENT__
		"WorkspaceTags" : {
			...
			"workspace.npm.npm.mongodb-client-encryption" : { "classification": "SystemMetaData", "purpose": "FeatureInsight", "isMeasurement": true },
			...
			"workspace.npm.onnruntime-node" : { "classification": "SystemMetaData", "purpose": "FeatureInsight", "isMeasurement": true },
			...
			"workspace.npm.postgre" : { "classification": "SystemMetaData", "purpose": "FeatureInsight", "isMeasurement": true },
